...
Не забудьте передать оставшиеся зависимости на сцене. На GameObject "Main Character" находятся компоненты "Attacker" и "Timer". Вы можете подобрать любую другую удобную архитектуру иерархии, важно передать в сам "Attacker" зависимостями "Timer" и "AnimationPlayer". Напомню, что, в свою очередь, сам "Attacker" зависимостью передаётся в "InputController".

Надеюсь, мой проект поможет Вам в реализации собственных боевых систем! По всем вопросам можете связаться со мной через мой [telegram-канал](https://t.me/de_mock).
